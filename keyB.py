...
_diff_target = 1
pears = [['270f023a5b04213b522b884d8aa6217c',
          '272c023a6504213b522b88278aa6897c'],
         ['454a97cc04305a3d939ae9b9c77a7985',
          '455a97cc4f305a3d939ae9b0c77af285'],
         ['e71b8182e8923fc28846ad06474f0a96',
          'e7c68182c9923fc28846ad87474fce96']]
    ...
    for pear in pears:
        ...
        for A in mode0_lis:
            for B in mode1_lis:
                ...
                if diff in D10: cand.append([key[0][1], key[1][0], key[2][3], key[3][2]])

        print(len(cand))
        guess_key.append(cand)

    with open('keyB.pkl', 'wb') as f:
