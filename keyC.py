...
_diff_target = 2
pears = [['302f9f3192fbd8f0c61e1173f6129da3',
          '302f6b31927ed8f0bc1e1173f6129d3a'],
         ['fded568a80c3567a33bb25328eb48101',
          'fdedf78a8069567a15bb25328eb4817c'],
         ['0d020ec304ccf3b652ed4d135a51ffcf',
          '0d028bc3043cf3b6deed4d135a51ff8f']]
    ...
    for pear in pears:
        ...
        for A in mode0_lis:
            for B in mode1_lis:
                ...
                if diff in D10:
                    cand.append([key[0][2], key[1][1], key[2][0], key[3][2]])

        print(len(cand))
        guess_key.append(cand)

    with open('keyC.pkl', 'wb') as f:
